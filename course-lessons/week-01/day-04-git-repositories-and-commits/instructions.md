...
- Explain and apply working tree.
- Explain and apply staging area.
- Explain and apply commit.
- Explain and apply diff review.
...
[Git basics](https://git-scm.com/book/en/v2/Git-Basics-Getting-a-Git-Repository) — read the syntax and boundary behavior used in this lesson.

## Navigation

[← Previous lesson](../../week-01/day-03-normalization-and-validation/instructions.md) · [Week overview](../README.md) · [Full curriculum](../../README.md) · [Next lesson →](../../week-01/day-05-authorization-scope-and-evidence/instructions.md)
