# Lesson 05.06: a dual-format campaign loader

**Phase:** Python for Marketing Data  
**Module:** Read Marketing Files  
**Track:** Python  
**Format:** Project  
**Status:** required
...
Read and validate campaign data from local CSV and JSON fixtures.
...
- CSV rows and JSON values
- pathlib and encodings
- file exceptions
- input contracts
- a dual-format campaign loader
