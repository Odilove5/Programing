# Lesson 08.06: Campaign and MetricSnapshot models

**Phase:** Reliable Business Logic & Data Models  
**Module:** Model the Marketing Domain  
**Track:** Python  
**Format:** Project  
**Status:** required
...
Represent core marketing concepts with typed dataclasses and enums.
...
- type hints
- model invariants
- Campaign and MetricSnapshot models
