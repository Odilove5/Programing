# Lesson 12.07: Review: Understand HTTP and REST

**Phase:** APIs & Business Data Integration  
**Module:** Understand HTTP and REST  
...
Model requests, responses, JSON contracts, timeouts, and API errors.
