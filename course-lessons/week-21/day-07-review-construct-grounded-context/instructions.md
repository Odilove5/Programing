# Lesson 21.07: Review: Construct Grounded Context

**Phase:** LLM Engineering  
**Module:** Construct Grounded Context  
...
Build prompts from verified goals, KPIs, and evidence while treating context as untrusted.
