# Lesson 24.06: read-only marketing tools

**Phase:** Tools, Agents & Orchestration  
**Module:** Define Typed Tools  
...
Create narrow tools with explicit input/output schemas and an allowlisted registry.
