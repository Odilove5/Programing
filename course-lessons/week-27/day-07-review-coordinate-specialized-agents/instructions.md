# Lesson 27.07: Review: Coordinate Specialized Agents

**Phase:** Tools, Agents & Orchestration  
**Module:** Coordinate Specialized Agents  
...
Introduce only roles with distinct contracts and evaluate their collaboration.
...
- Strategist and Analyst roles
- Research and Content roles
- handoff schemas
- agent evaluation
- Agent Workflow
